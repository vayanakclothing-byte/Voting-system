      ...
      <header className="w-full glass-panel border-b border-slate-800/80 sticky top-0 z-40 px-4 md:px-8 py-3 flex items-center justify-between transition-all duration-300">
        ...
        <div className="flex items-center gap-3 cursor-pointer" onClick={() => navigate('/')}>
          <div className="w-10 h-10 md:w-12 md:h-12 flex items-center justify-center shrink-0">
            <img src="/accec/logo.png" alt="Royal Academy Logo" className="w-full h-full object-contain filter drop-shadow-md" onError={(e) => { (e.target as HTMLImageElement).src = 'https://api.dicebear.com/7.x/shapes/svg?seed=RA'; }} />
          </div>
          <div>
