...
export const ParticlesBackground: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
      ...
      <div className={`absolute top-10 left-[10%] w-64 md:w-96 h-64 md:h-96 rounded-full blur-[80px] md:blur-[100px] animate-pulse-slow ${colors.orb1}`} />
      <div className={`absolute bottom-20 right-[10%] w-72 md:w-[30rem] h-72 md:h-[30rem] rounded-full blur-[80px] md:blur-[120px] animate-pulse-slow ${colors.orb2}`} style={{ animationDelay: '2s' }} />
      <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 md:w-[25rem] h-64 md:h-[25rem] rounded-full blur-[60px] md:blur-[90px] animate-pulse-slow ${colors.orb3}`} style={{ animationDelay: '4s' }} />
